      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">Unique pieces from talented artists.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <li>
              <a href="https://www.youtube.com/@aroc_art" target="_blank" className="text-gray-400 hover:text-white" aria-label="Youtube">
            ...
            <li>
              <a href="https://tiktok.com/@aroc_art" target="_blank" className="text-gray-400 hover:text-white" aria-label="Tiktok">
              ...
              <li>
                < a href="https://www.instagram.com/aroc__art" target="_blank" className="text-gray-400 hover:text-white" aria-label="Instagram"> 
            ...
            <li>
              <a href="https://x.com/aroc__art" target="_blank" className="text-gray-400 hover:text-white" aria-label="Twitter">
            ...
            {/* <li>
              <a href="https://x.com/aroc__art" target="_blank" className="text-gray-400 hover:text-white" aria-label="Whatsapp">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-twitter-x" viewBox="0 0 16 16">
              <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
              </svg>
              </a>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Aroc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
